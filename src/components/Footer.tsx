...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-white dark:bg-dark-card border-t border-navy/5 dark:border-gold/5 pt-12 sm:pt-24 pb-8 sm:pb-12 transition-colors duration-500">
      <div className="news-container">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 sm:gap-16 items-start">
          {/* Brand */}
          <div className="md:col-span-4 flex flex-col items-center md:items-start text-center md:text-left">
            <Link to="/" className="flex flex-col mb-6 sm:mb-8 group">
          ...
          <div className="md:col-span-4 flex flex-col items-center md:items-end">
            <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.2em] text-navy/30 dark:text-gold/30 mb-4 sm:mb-8">{t('footer.connect')}</span>
        ...
        {/* Copyright */}
        <div className="mt-12 sm:mt-24 pt-8 sm:pt-12 border-t border-navy/5 dark:border-gold/5 flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0 text-center md:text-left">
